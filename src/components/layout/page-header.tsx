    ...
    <section className="app-card overflow-hidden">
      <div className="flex flex-col gap-5 p-6 sm:p-7 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex min-w-0 gap-4">
          <div className="hidden h-14 w-14 shrink-0 items-center justify-center rounded-3xl bg-gradient-to-br from-rose-500 to-amber-600 text-white shadow-lg shadow-rose-500/20 sm:flex">
            <Icon size={26} />
          </div>
          ...
          <div className="min-w-0">
            <div className="mb-3 flex flex-wrap items-center gap-2">
              {backHref ? (
                <Link
                  href={backHref}
                  className="inline-flex items-center gap-2 rounded-full border border-[var(--app-border)] bg-white px-3 py-1.5 text-xs font-extrabold text-[var(--app-text-muted)] transition hover:border-rose-200 hover:text-[var(--primary)] hover:shadow-sm hover:shadow-rose-100/50"
                >
                  <ArrowRight size={14} />
                  {backLabel}
                </Link>
