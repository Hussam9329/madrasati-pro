...
const shortcuts = [
  { category: 'التنقل', items: [
    ...
    { keys: ['Ctrl', '5'], description: 'الحضور' },
    { keys: ['Ctrl', '6'], description: 'الدرجات' },
    { keys: ['Ctrl', '7'], description: 'ترتيب الصفوف' },
    { keys: ['Ctrl', '8'], description: 'الامتحانات' },
    { keys: ['Ctrl', '9'], description: 'الرسوم المدرسية' },
  ]},
  { category: 'عام', items: [
